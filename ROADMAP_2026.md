...
**Stand:** 11. April 2026 · Version 0.8.7
...
- ✅ i18n-Ausbau abgeschlossen: FR/ES/NL/IT als produktive UI-Sprachen integriert (vollstaendige Key-Abdeckung)
- ✅ Locale-Architektur erweitert: JSON-Locales (`src/photo_cleaner/i18n_locales/*.json`) werden beim Start geladen
- ✅ Reproduzierbarer Translation-Workflow ergaenzt: `scripts/generate_locale_translations.py` erzeugt FR/ES/NL/IT aus EN/DE-Basis mit Placeholder-Schutz
