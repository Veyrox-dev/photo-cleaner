...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "de": {
        ...
        "start_dialog_welcome_title": "Willkommen bei PhotoCleaner",
        "start_dialog_welcome_info": "Wählen Sie den Input-Ordner mit Ihren Bildern und den Output-Ordner für die sortierten Bilder.",
        "start_dialog_input_placeholder": "Ordner mit zu sortierenden Bildern...",
        "start_dialog_output_placeholder": "Zielordner für sortierte Bilder...",
        "start_dialog_pick_input_title": "Input-Ordner wählen",
        "start_dialog_pick_output_title": "Output-Ordner wählen",
        "start_dialog_missing_selection_title": "Fehlende Auswahl",
        "start_dialog_invalid_selection_title": "Ungültige Auswahl",
        "start_dialog_invalid_input": "Bitte wählen Sie einen gültigen Input-Ordner.",
        "start_dialog_invalid_output": "Bitte wählen Sie einen gültigen Output-Ordner.",
        "start_dialog_same_folder_error": "Input- und Output-Ordner dürfen nicht identisch sein.",
        "start_dialog_output_inside_input_error": "Output-Ordner darf nicht innerhalb des Input-Ordners liegen.",
        "start_dialog_input_inside_output_error": "Input-Ordner darf nicht innerhalb des Output-Ordners liegen.",
        "start_dialog_output_create_failed": "Output-Ordner konnte nicht erstellt werden:\n{error}",
        ...
        "thumbnail_checkbox_tooltip": "Auswahl umschalten",
        "keep": "Behalten",
        ...
        "first_run_setup_title": "Erststart einrichten",
        "first_run_setup_subtitle": "Legen Sie die wichtigsten Einstellungen fest, bevor Sie Ihre erste Session starten.",
        "first_run_setup_intro": "PhotoCleaner kann sofort starten. Für einen sauberen ersten Durchlauf setzen Sie hier Sprache, Design und das Löschverhalten fest.",
        "first_run_setup_settings_hint": "Diese Auswahl können Sie später jederzeit in den Einstellungen ändern.",
        "first_run_setup_delete_strategy_hint": "Empfehlung: Lassen Sie die Lösch-Bestätigung aktiv, bis Sie den Workflow ein paar Sessions genutzt haben.",
        "first_run_setup_skip": "Später",
        "first_run_setup_continue": "Weiter",
        ...
        "onboarding_step_welcome_body": "Diese Tour zeigt dir die wichtigsten Bereiche für einen sicheren, schnellen Start.\n\nSo nutzt du sie am besten:\n• Folge den Schritten von links nach rechts\n• Nutze Unsicher bei Zweifeln\n• Am Ende exportierst du nur die KEEP-Bilder\n\nDu kannst jederzeit mit Weiter/Zurück navigieren.",
        "onboarding_step_import_title": "1) Bilder importieren",
        "onboarding_step_import_body": "Starte immer hier: Wähle deinen Bildordner.\n\nDanach läuft die Analyse automatisch und PhotoCleaner erstellt Gruppen mit ähnlichen Bildern.\n\nTipp: Für den ersten Test am besten einen kleineren Ordner (z. B. 100-500 Bilder) nutzen.",
        "onboarding_step_filter_title": "2) Gruppen finden",
        "onboarding_step_filter_body": "Mit Suche und Filter findest du sofort die relevanten Gruppen.\n\nEmpfohlener Ablauf:\n• zuerst offene Gruppen\n• dann unsichere/problematische Gruppen\n• abgeschlossene Gruppen nur noch für Kontrolle",
        "onboarding_step_groups_title": "3) Gruppenliste verstehen",
        "onboarding_step_groups_body": "Jede Zeile ist eine Gruppe ähnlicher Bilder.\n\nFarblogik:\n• Rot = noch Entscheidungen offen\n• Grün = vollständig entschieden\n\nWähle eine Gruppe aus und prüfe danach die Bilder im Review-Bereich.",
        "onboarding_step_actions_title": "4) Entscheidungen treffen",
        "onboarding_step_actions_body": "Hier triffst du die eigentlichen Entscheidungen:\n• Behalten (KEEP)\n• Löschen (DELETE)\n• Unsicher (UNSURE)\n\nBest Practice:\n• klare Treffer direkt KEEP/DELETE\n• unklare Fälle erstmal UNSURE\n• bei Fehlern sofort Undo nutzen\n\nShortcuts: K, D, U, Z",
        "onboarding_step_undo_title": "5) Undo & Verlauf nutzen",
        "onboarding_step_undo_body": "Fehlklick? Kein Problem.\n\nMit Undo nimmst du die letzte Aktion direkt zurück.\nNutze den Bereich ""Recent Actions"", um schnell zu sehen, was zuletzt geändert wurde.",
        "onboarding_step_status_title": "6) Fortschritt im Blick behalten",
        "onboarding_step_status_body": "Unten siehst du den laufenden Fortschritt und den aktuellen Status deiner Session.\n\nSo erkennst du sofort, wie weit die Entscheidungen und Exporte sind.",
        "onboarding_step_finalize_title": "7) Export abschließen",
        "onboarding_step_finalize_body": "Wenn deine Entscheidungen fertig sind, exportierst du hier alle KEEP-Bilder in den Ausgabeordner.\n\nVorher kurz prüfen:\n• offene Gruppen abgeschlossen\n• UNSURE-Fälle bewusst entschieden\n• Ausgabepfad korrekt gesetzt",
        "onboarding_step_settings_title": "8) Einstellungen & Updates",
        "onboarding_step_settings_body": "Im Bereich Einstellungen findest du Analyse- und Systemoptionen.\n\nDort kannst du jetzt auch manuell 'Nach Updates suchen' ausführen.\nDas ist der richtige Ort für Wartung und Feintuning.",
        ...
        "fresh_session": "Frische Session",
        "fresh_session_tooltip": "Entscheidungen und Gruppen zurücksetzen und mit einem neuen Scan starten",
        "fresh_session_title": "Frische Session starten",
        "fresh_session_confirm": "Diese Aktion setzt Gruppen, Entscheidungen und Caches zurück. Die indexierten Dateien bleiben erhalten. Danach können Sie direkt einen neuen Ordner scannen. Fortfahren?",
        "fresh_session_done": "Die aktuelle Session wurde zurückgesetzt. Wählen Sie jetzt einen Ordner für den neuen Durchlauf.",
        "fresh_session_failed": "Frische Session konnte nicht gestartet werden.",
        ...
        "cache_dialog_title": "Cache-Verwaltung",
        "cache_stats_group": "Cache-Statistiken",
        "cache_refresh_stats": "Statistik aktualisieren",
        "cache_control_group": "Cache-Steuerung",
        "cache_enable_checkbox": "Caching aktivieren (empfohlen)",
        "cache_force_reanalyze_checkbox": "Beim nächsten Lauf neu analysieren erzwingen (Cache ignorieren)",
        "cache_clear_older_than": "Einträge älter als löschen:",
        "cache_days_suffix": " Tage",
        "cache_clear_button": "Leeren",
        "cache_clear_all_button": "Gesamten Cache leeren",
        "cache_manager_unavailable": "Cache-Manager nicht verfügbar",
        "cache_stats_header": "CACHE-STATISTIKEN",
        "cache_total_entries": "Gesamteinträge:      {count}",
        "cache_avg_quality": "Durchschnittsqualität: {value:.2f}",
        "cache_topn_entries": "Top-N-Einträge:      {count}",
        "cache_oldest_entry": "Ältester Eintrag:    {value}",
        "cache_newest_entry": "Neuester Eintrag:    {value}",
        "cache_not_available": "N/V",
        "cache_session_stats_header": "SITZUNGS-STATISTIKEN",
        "cache_hits": "Cache-Treffer:       {count}",
        "cache_misses": "Cache-Fehler:        {count}",
        "cache_updates": "Cache-Updates:       {count}",
        "cache_hit_rate": "Trefferquote:        {rate:.1f}%",
        "cache_stats_error": "Fehler beim Laden der Statistiken:\n{error}",
        "cache_confirm_title": "Bestätigen",
        "cache_clear_old_confirm": "Cache-Einträge löschen, die älter als {days} Tage sind?\n\nDiese Bilder müssen danach erneut analysiert werden.",
        "cache_clear_all_confirm": "Gesamten Cache löschen?\n\nAlle zwischengespeicherten Analyseergebnisse werden entfernt.\nBeim nächsten Scan müssen alle Bilder neu analysiert werden.",
        "cache_cleared_count": "{count} Cache-Einträge wurden gelöscht.",
        "cache_clear_failed_detail": "Cache konnte nicht geleert werden:\n{error}",
        "cache_status_disabled": "Cache: Deaktiviert",
        "cache_status_summary": "Cache: {entries} Einträge | Treffer: {hits} | Trefferquote: {rate:.0f}%",
        "cache_status_error": "Cache: Fehler beim Laden des Status",
        ...
        "settings_general_group": "Allgemein",
        "settings_language_label": "Sprache:",
        "settings_theme_label": "Design:",
        "settings_show_advanced": "Erweiterte Gruppierung anzeigen",
        "settings_advanced_group": "Erweiterte Gruppierung",
        "settings_group_time_window": "Zeitfenster (Sekunden):",
        "settings_group_relaxed_similarity": "Relaxte Ähnlichkeit:",
        ...
        "auto_keep_tiers_title": "Auto-Behalten – Stufen",
        "auto_keep_tiers_row_prefix": "<",
        "auto_keep_tiers_row_middle": "Fotos → behalte",
        "auto_keep_tiers_large_prefix": "Große Gruppe → behalte",
        "export_format_original": "Original (ohne Konvertierung)",
        "export_format_jpg": "JPG",
        "export_format_png": "PNG",
        "export_format_webp": "WebP",
        "export_format_tiff": "TIFF",
        "export_format_bmp": "BMP",
        "export_structure_label": "Export-Struktur",
        "export_structure_date": "Nach Datum (JJJJ/MM/TT)",
        "export_structure_year_month": "Nach Monat (JJJJ/MM)",
        "export_structure_year": "Nach Jahr (JJJJ)",
        "export_structure_month_day": "Nach Monat/Tag (MM/TT)",
        "export_structure_month": "Nur Monat (MM)",
        "export_structure_flat": "Flach (keine Unterordner)",
        ...
        "license_key_invalid_format": "Ungültiges Schlüsselformat. Erlaubt sind nur A-Z, 0-9 und '-'.",
        "license_key_too_long": "Lizenzschlüssel ist zu lang (maximal 128 Zeichen).",
...
💡 Für unbegrenzte Bilder und Premium-Features:
       → Upgrade auf PRO""",
        ...
        "installation_error_package": "Fehler bei {package}: {message}",
        "installation_all_packages_installed": "Alle Pakete erfolgreich installiert!",
        "installation_system_info_title": "System-Informationen",
        "installation_os_label": "Betriebssystem: {name} ({version})",
        "installation_arch_64": "64-bit",
        "installation_arch_32": "32-bit",
        "installation_python_label": "Python: {version} ({arch})",
        "installation_cpu_cores_label": "CPU Kerne: {count}",
        "installation_state_available": "Verfügbar",
        "installation_state_not_detected": "Nicht erkannt",
        "installation_gpu_label": "GPU: {state}",
        "installation_build_tools_label": "C++ Build Tools: {state}",
        "installation_packages_title": "Zu installierende Pakete",
        "installation_mediapipe_description": "<b>MediaPipe</b> (Stufe 3)<br><i>Einfach, {size} MB, beste Genauigkeit</i>",
        "installation_dlib_description": "<b>dlib</b> (Stufe 2)<br><i>Mittel, {size} MB, benötigt C++ Build Tools</i>",
        "installation_installed": "Installiert",
        "installation_build_tools_missing": "Build Tools fehlen",
        "installation_build_tools_missing_tooltip": "Installation kann fehlschlagen ohne Build Tools",
        "installation_already_installed": "Alle erweiterten Funktionen sind bereits installiert.",
        "installation_recommendation_prefix": "<b>Empfehlung für Ihr System:</b> {package}<br>",
        "installation_confirm_packages": "Folgende Pakete werden installiert:\n\n{packages}\n\nDie Installation erfolgt im User-Space (keine Admin-Rechte erforderlich).\n\nFortfahren?",
        "installation_start_log": "Starte Installation: {packages}",
        "installation_success_message": "{message}\n\nDie neuen Funktionen sind jetzt verfügbar.\n\nBitte starten Sie die Analyse neu, um die Änderungen zu übernehmen.",
        "installation_failure_message": "{message}\n\nBitte überprüfen Sie das Log für Details oder installieren Sie manuell.",
        "close_button": "Schließen",
        "previous_image": "Vorheriges Bild",
        "next_image": "Nächstes Bild",
        "merge_groups": "Gruppen zusammenführen",
        "merge_select_min_two": "Bitte wählen Sie mindestens 2 Gruppen zum Zusammenführen aus.",
        "merge_confirm_title": "Gruppen zusammenführen?",
        "merge_confirm_message": "Möchten Sie {count} Gruppen zusammenführen?\n\nDie Bilder werden in einer neuen Gruppe zusammengefasst und automatisch neu bewertet.",
        "merge_error_detail": "Fehler beim Zusammenführen: {error}",
        "merge_success_status": "Zusammenführen erfolgreich: {count} Gruppen -> 1 Gruppe",
        "merge_success_without_rerating": "Zusammenführen erfolgreich (ohne Neubewertung)",
        "merge_progress_title": "Gruppen werden zusammengeführt",
        "merge_progress_phase_prepare": "Bereite Zusammenführung vor...",
        "merge_progress_phase_models": "Lade Bewertungsmodelle...",
        "merge_progress_phase_compare": "Vergleiche Bilder...",
        "merge_progress_phase_scoring": "Führe Gruppen zusammen und bewerte neu...",
        "merge_progress_phase_finalize": "Speichere Ergebnisse...",
        "merge_progress_phase_done": "Zusammenführung abgeschlossen",
        "merge_progress_detail_prepare": "Prüfe ausgewählte Gruppen...",
        "merge_progress_detail_found_images": "{count} Bilder in der Zielgruppe gefunden",
        "merge_progress_detail_models": "Modelle werden initialisiert",
        "merge_progress_detail_compare_count": "Vergleiche Bildqualität: {current}/{total}",
        "merge_progress_detail_scoring_count": "Aktualisiere Bewertungen: {current}/{total}",
        "merge_progress_detail_finalize": "Übernehme Auswahl und speichere Datenbankänderungen",
        "merge_progress_detail_done": "Zusammenführung und Neubewertung abgeschlossen",
        ...
        "import_safe_review_hint": "Safe Review: Prüfe zuerst unsichere Gruppen, nutze KEEP/DELETE nur bei klaren Treffern und lasse Zweifel auf Unsicher.",
        ...
        "validation_optional_input": "Bitte wähle zuerst einen Foto-Ordner aus.",
        "pro_upgrade_button": "⭐ Jetzt auf Pro upgraden",
        "validation_ready": "Alles bereit. Die Analyse kann starten.",
        "validation_free_limit_exceeded": "Free-Lizenz: Dein Gesamtlimit beträgt 250 Bilder. Bisher gescannt: {used}. In diesem Ordner: {count}. Zu viel – bitte wähle einen kleineren Ordner oder upgrade auf Pro.",
        "validation_free_quota_remaining": "Free-Lizenz: Noch {remaining} von 250 Bildern übrig.",
        ...
        "progress_step_1_index_hash": "Schritt 1/3: Bilder einlesen und hashen... ({current}/{total})",
        "progress_step_2_grouping_legacy": "Schritt 2/3: Duplikatgruppen werden erstellt...",
        "progress_step_3_rating_start": "Schritt 3/3: Bildbewertung startet...",
        "progress_step_3_rating_legacy": "Schritt 3/3: Bilder werden bewertet",
        "progress_step_4_finalizing_legacy": "Schritt 3/3: Abschluss und Anzeige wird vorbereitet...",
        ...
        "analysis_activity_title": "Analyse-Aktivitaet",
        "analysis_activity_ready": "Fortschritt gestartet",
        "cancel_in_progress": "Abbruch wird ausgeführt...",
        "warning": "Warnung",
        "success": "Erfolg",

        "exif_data_header": "<h4>EXIF-Daten</h4>",
        "exif_loading": "<i>EXIF-Daten werden geladen...</i>",
        "exif_display_error": "<i>Fehler beim Anzeigen von EXIF-Daten: {error}</i>",
        "exif_load_error": "<i>EXIF-Daten konnten nicht geladen werden: {error}</i>",
        "zoom_ctrl_wheel_fine": "Strg+Mausrad: Feiner Zoom",
        "zoom_reset": "0: Zoom zurücksetzen",
        "zoom_fit_view": "Doppelklick: An Ansicht anpassen",
        "zoom_drag_pan": "Ziehen: Bild verschieben",
        "detail_dialog_title": "Detail: {name}",
        "detail_window_title": "Detailansicht - {name}",
        "detail_badge_recommended": "Empfohlen",
        "detail_badge_locked": "Gesperrt",
        "no_quality_data_available": "Keine Qualitätsdaten verfügbar",
        "image_could_not_be_loaded": "Bild konnte nicht geladen werden",
        "exif_no_data": "<i>Keine EXIF-Daten verfügbar</i>",
        "exif_display_error_simple": "<i>Fehler beim Anzeigen von EXIF-Daten</i>",
        "exif_load_error_simple": "<i>EXIF-Daten konnten nicht geladen werden</i>",
        "progress_rating_images": "Bilder werden bewertet...",
        "progress_loading_models": "Lade Modelle...",
        "progress_rating_images_count": "Bilder werden bewertet... {done}/{total}",
        "progress_re_rating_group": "Gruppe wird neu bewertet...",

        "error_report_email_placeholder": "beispiel@website.de",
        "error_report_empty_input": "Bitte geben Sie E-Mail oder Nachricht ein.",

        "analysis_error_title": "Fehler bei der Analyse",
        "analysis_error_header": "Bei der Analyse ist ein Fehler aufgetreten:\n\n",
        "analysis_error_details": "Fehlerdetails: {error}\n\n",
        "analysis_error_checklist": "Bitte stellen Sie sicher, dass:\n• Der Ordner gültige Bilddateien enthält\n• Sie Leserechte für den Ordner haben\n• Genügend Speicherplatz vorhanden ist",

        "mtcnn_warning_title": "Gesichtserkennung Hinweis",
        "mtcnn_warning_header": "<b>Moderne Gesichtserkennung nicht verfügbar</b>",
        "mtcnn_warning_body": "PhotoCleaner konnte die moderne Gesichtserkennung (MTCNN) nicht initialisieren.\n\nFehler: {error}\n\nDas Programm funktioniert weiterhin, verwendet aber eine ältere Methode (Haar Cascade) zur Gesichtserkennung. Dies kann die Genauigkeit bei der Auswahl der besten Fotos mit Gesichtern beeinträchtigen.\n\nDie Analyse von Bildschärfe, Belichtung und anderen Qualitätsmerkmalen funktioniert normal.",
        ...
        # QUICK-WIN #3: Confirmation dialogs
        "confirm_delete_files": "Wirklich {count} Bild(er) löschen?",
        "affected_files": "Betroffene Dateien:",
        "warning_cannot_undo": "Dies kann nicht rückgängig gemacht werden!",
        "confirm_batch_operation": "Batch-Operation bestätigen",
        "mark_files_as": "Sollen {count} Bild(er) als '{status}' markiert werden?",
        
        # QUICK-WIN #1: Empty states
        "gallery_empty_title": "Keine Bilder in der Galerie",
        "gallery_empty_subtitle": "Lassen Sie mich Ihnen helfen, loszulegen",
        "gallery_empty_steps": "Erste Schritte:",
        "gallery_empty_step1": "Scannen Sie einen Ordner auf Bilder",
        "gallery_empty_step2": "Die App analysiert und erkennt Duplikate",
        "gallery_empty_step3": "Überprüfen Sie Duplikat-Gruppen",
        "gallery_empty_step4": "Exportieren Sie die besten Versionen",
        "gallery_empty_import_button": "Jetzt einen Ordner scannen",
        
        # QUICK-WIN #5: Hardcoded strings → i18n
        "preset_loaded": "Voreinstellung '{name}' geladen",
        "preset_saved": "Voreinstellung '{name}' gespeichert",
        "preset_cannot_delete_builtin": "Kann vordefiniertes Preset '{name}' nicht löschen.",
        "settings_updated": "Einstellungen aktualisiert",
        "config_validation_error": "Fehler in '{key}': {error}",
        "quality_details_missing": "Details fehlen: für diese Datei bitte Analyse erneut ausführen.",
        "preset_label": "Voreinstellung:",
        "update_available": "Update verfügbar",
        "update_new_version": "Neue Version verfügbar: {latest}\nAktuell installiert: {current}",
        "update_open_download_prompt": "Download-Seite jetzt öffnen?",
        "update_open_download": "Download öffnen",
        "update_later": "Später",
        "update_link_failed": "Download-Link konnte nicht geöffnet werden:\n{url}",
        "update_manifest_no_version": "Manifest ohne latest_version",
        "update_manifest_no_url": "Manifest ohne download_url",
        "update_up_to_date": "Du nutzt bereits die aktuelle Version ({version}).",
        "eye_detection_config_apply_failed": "Konfiguration konnte nicht angewendet werden. Bitte prüfen Sie die Einstellungen.",
        "installation_select_package": "Bitte wählen Sie ein Paket zur Installation aus.",
        "information": "Information",
    },
    "en": {
        ...
        "start_dialog_welcome_title": "Welcome to PhotoCleaner",
        "start_dialog_welcome_info": "Choose the input folder with your photos and the output folder for sorted photos.",
        "start_dialog_input_placeholder": "Folder with photos to sort...",
        "start_dialog_output_placeholder": "Target folder for sorted photos...",
        "start_dialog_pick_input_title": "Select input folder",
        "start_dialog_pick_output_title": "Select output folder",
        "start_dialog_missing_selection_title": "Missing selection",
        "start_dialog_invalid_selection_title": "Invalid selection",
        "start_dialog_invalid_input": "Please select a valid input folder.",
        "start_dialog_invalid_output": "Please select a valid output folder.",
        "start_dialog_same_folder_error": "Input and output folders must not be the same.",
        "start_dialog_output_inside_input_error": "Output folder must not be inside the input folder.",
        "start_dialog_input_inside_output_error": "Input folder must not be inside the output folder.",
        "start_dialog_output_create_failed": "Could not create output folder:\n{error}",
        ...
        "thumbnail_checkbox_tooltip": "Toggle selection",
        "keep": "Keep",
        ...
        "first_run_setup_title": "Set up your first session",
        "first_run_setup_subtitle": "Choose the important defaults before you start working with your photos.",
        "first_run_setup_intro": "PhotoCleaner is ready to run immediately. Use this quick step to choose language, theme, and delete behavior for a cleaner first session.",
        "first_run_setup_settings_hint": "You can change these choices later in Settings at any time.",
        "first_run_setup_delete_strategy_hint": "Recommendation: keep delete confirmation enabled until you are confident with the workflow.",
        "first_run_setup_skip": "Later",
        "first_run_setup_continue": "Continue",
        ...
        "onboarding_step_welcome_body": "This tour covers the key areas for a safe and fast start.\n\nBest way to use it:\n• follow steps from left to right\n• use Unsure for uncertain cases\n• export KEEP images at the end\n\nYou can move with Next/Back at any time.",
        "onboarding_step_import_title": "1) Import images",
        "onboarding_step_import_body": "Always start here: choose your image folder.\n\nAnalysis runs automatically and PhotoCleaner builds groups of similar images.\n\nTip: use a smaller folder first (for example 100-500 images).",
        "onboarding_step_filter_title": "2) Find groups quickly",
        "onboarding_step_filter_body": "Use search and filters to focus on the right groups quickly.\n\nRecommended order:\n• open groups first\n• then uncertain/problematic groups\n• completed groups only for final checks",
        "onboarding_step_groups_title": "3) Understand the group list",
        "onboarding_step_groups_body": "Each row is one group of similar images.\n\nColor logic:\n• Red = decisions still open\n• Green = fully decided\n\nSelect a group and review its images in the main review area.",
        "onboarding_step_actions_title": "4) Make decisions",
        "onboarding_step_actions_body": "This is where decisions happen:\n• Keep\n• Delete\n• Unsure\n\nBest practice:\n• set clear winners directly\n• leave unclear cases as Unsure\n• use Undo immediately if needed\n\nShortcuts: K, D, U, Z",
        "onboarding_step_undo_title": "5) Use Undo & history",
        "onboarding_step_undo_body": "Made a wrong click? No problem.\n\nUse Undo to revert the latest action right away.\nUse ""Recent Actions"" to understand what changed most recently.",
        "onboarding_step_status_title": "6) Track progress",
        "onboarding_step_status_body": "The bottom status area shows your live progress and current session state.\n\nIt helps you see how far decisions and export have progressed.",
        "onboarding_step_finalize_title": "7) Finalize export",
        "onboarding_step_finalize_body": "When decisions are complete, export all KEEP images to the output folder here.\n\nQuick checklist:\n• open groups completed\n• unsure cases resolved intentionally\n• output path is correct",
        "onboarding_step_settings_title": "8) Settings & updates",
        "onboarding_step_settings_body": "In Settings you can manage analysis and system options.\n\nManual 'Check for updates' is now located there as part of maintenance and tuning.",
        ...
        "fresh_session_tooltip": "Reset decisions and groups, then start with a new scan",
        "fresh_session_title": "Start fresh session",
        "fresh_session_confirm": "This resets groups, decisions, and caches while keeping the indexed files. After that you can immediately scan a new folder. Continue?",
        "fresh_session_done": "The current session was reset. Choose a folder now to start the next pass.",
        "fresh_session_failed": "Fresh session could not be started.",
        ...
        "cache_dialog_title": "Cache Management",
        "cache_stats_group": "Cache Statistics",
        "cache_refresh_stats": "Refresh statistics",
        "cache_control_group": "Cache Control",
        "cache_enable_checkbox": "Enable caching (recommended)",
        "cache_force_reanalyze_checkbox": "Force re-analysis on next run (ignore cache)",
        "cache_clear_older_than": "Clear entries older than:",
        "cache_days_suffix": " days",
        "cache_clear_button": "Clear",
        "cache_clear_all_button": "Clear all cache",
        "cache_manager_unavailable": "Cache manager not available",
        "cache_stats_header": "IMAGE CACHE STATISTICS",
        "cache_total_entries": "Total entries:       {count}",
        "cache_avg_quality": "Average quality:     {value:.2f}",
        "cache_topn_entries": "Top-N entries:       {count}",
        "cache_oldest_entry": "Oldest entry:        {value}",
        "cache_newest_entry": "Newest entry:        {value}",
        "cache_not_available": "N/A",
        "cache_session_stats_header": "SESSION STATISTICS",
        "cache_hits": "Cache hits:          {count}",
        "cache_misses": "Cache misses:        {count}",
        "cache_updates": "Cache updates:       {count}",
        "cache_hit_rate": "Hit rate:            {rate:.1f}%",
        "cache_stats_error": "Error retrieving statistics:\n{error}",
        "cache_confirm_title": "Confirm",
        "cache_clear_old_confirm": "Clear cache entries older than {days} days?\n\nThese images will need to be re-analyzed.",
        "cache_clear_all_confirm": "Clear entire cache?\n\nAll cached analysis results will be deleted.\nNext scan will require full re-analysis of all images.",
        "cache_cleared_count": "Cleared {count} cache entries.",
        "cache_clear_failed_detail": "Failed to clear cache:\n{error}",
        "cache_status_disabled": "Cache: Disabled",
        "cache_status_summary": "Cache: {entries} entries | Hits: {hits} | Hit rate: {rate:.0f}%",
        "cache_status_error": "Cache: Error retrieving status",
        ...
        "export_tab": "Export",
        "settings_tab_analysis": "Analysis",
        "settings_tab_workflow": "Workflow",
        "settings_tab_system": "System",
        ...
        "settings_show_advanced": "Show advanced grouping",
        "settings_advanced_group": "Advanced grouping",
        "settings_group_time_window": "Time window (seconds):",
        "settings_group_relaxed_similarity": "Relaxed similarity:",
        ...
        "auto_keep_tiers_title": "Auto-Keep Tiers",
        "auto_keep_tiers_row_prefix": "<",
        "auto_keep_tiers_row_middle": "photos → keep",
        "auto_keep_tiers_large_prefix": "Large group → keep",
        "export_format_original": "Original (no conversion)",
        "export_format_jpg": "JPG",
        "export_format_png": "PNG",
        "export_format_webp": "WebP",
        "export_format_tiff": "TIFF",
        "export_format_bmp": "BMP",
        "export_structure_label": "Export Structure",
        "export_structure_date": "By date (YYYY/MM/DD)",
        "export_structure_year_month": "By month (YYYY/MM)",
        "export_structure_year": "By year (YYYY)",
        "export_structure_month_day": "By month/day (MM/DD)",
        "export_structure_month": "By month only (MM)",
        "export_structure_flat": "Flat (no subfolders)",
        ...
        "license_key_invalid_format": "Invalid key format. Only A-Z, 0-9 and '-' are allowed.",
        "license_key_too_long": "License key is too long (maximum 128 characters).",
...
💡 For unlimited images and premium features:
       → Upgrade to PRO""",
        ...
        "installation_error_package": "Error with {package}: {message}",
        "installation_all_packages_installed": "All packages installed successfully!",
        "installation_system_info_title": "System Information",
        "installation_os_label": "Operating system: {name} ({version})",
        "installation_arch_64": "64-bit",
        "installation_arch_32": "32-bit",
        "installation_python_label": "Python: {version} ({arch})",
        "installation_cpu_cores_label": "CPU cores: {count}",
        "installation_state_available": "Available",
        "installation_state_not_detected": "Not detected",
        "installation_gpu_label": "GPU: {state}",
        "installation_build_tools_label": "C++ Build tools: {state}",
        "installation_packages_title": "Packages to install",
        "installation_mediapipe_description": "<b>MediaPipe</b> (Stage 3)<br><i>Easy, {size} MB, best accuracy</i>",
        "installation_dlib_description": "<b>dlib</b> (Stage 2)<br><i>Medium, {size} MB, requires C++ build tools</i>",
        "installation_installed": "Installed",
        "installation_build_tools_missing": "Build tools missing",
        "installation_build_tools_missing_tooltip": "Installation may fail without build tools",
        "installation_already_installed": "All advanced features are already installed.",
        "installation_recommendation_prefix": "<b>Recommendation for your system:</b> {package}<br>",
        "installation_confirm_packages": "The following packages will be installed:\n\n{packages}\n\nInstallation runs in user space (no admin rights required).\n\nContinue?",
        "installation_start_log": "Starting installation: {packages}",
        "installation_success_message": "{message}\n\nThe new features are now available.\n\nPlease restart analysis to apply the changes.",
        "installation_failure_message": "{message}\n\nPlease check the log for details or install manually.",
        "close_button": "Close",
        "previous_image": "Previous Image",
        "next_image": "Next Image",
        "merge_groups": "Merge Groups",
        "merge_select_min_two": "Please select at least 2 groups to merge.",
        "merge_confirm_title": "Merge groups?",
        "merge_confirm_message": "Do you want to merge {count} groups?\n\nImages will be combined into a new group and re-rated automatically.",
        "merge_error_detail": "Error merging groups: {error}",
        "merge_success_status": "Merge successful: {count} groups -> 1 group",
        "merge_success_without_rerating": "Merge successful (without re-rating)",
        "merge_progress_title": "Merging groups",
        "merge_progress_phase_prepare": "Preparing merge...",
        "merge_progress_phase_models": "Loading rating models...",
        "merge_progress_phase_compare": "Comparing images...",
        "merge_progress_phase_scoring": "Merging groups and re-rating...",
        "merge_progress_phase_finalize": "Saving results...",
        "merge_progress_phase_done": "Merge completed",
        "merge_progress_detail_prepare": "Checking selected groups...",
        "merge_progress_detail_found_images": "Found {count} images in target group",
        "merge_progress_detail_models": "Initializing rating models",
        "merge_progress_detail_compare_count": "Comparing image quality: {current}/{total}",
        "merge_progress_detail_scoring_count": "Updating scores: {current}/{total}",
        "merge_progress_detail_finalize": "Applying selection and saving database changes",
        "merge_progress_detail_done": "Merge and re-rating completed",
        ...
        "import_safe_review_hint": "Safe Review: inspect uncertain groups first, use KEEP/DELETE only for clear matches, and leave doubtful images as Unsure.",
        ...
        "validation_optional_input": "Please select a photo folder first.",
        "pro_upgrade_button": "⭐ Upgrade to Pro",
        "validation_ready": "Everything is ready. The analysis can start.",
        "validation_free_limit_exceeded": "Free license: Your lifetime limit is 250 images. Already scanned: {used}. In this folder: {count}. Too many – please choose a smaller folder or upgrade to Pro.",
        "validation_free_quota_remaining": "Free license: {remaining} of 250 images remaining.",
        ...
        "progress_step_1_index_hash": "Step 1/3: Reading and hashing images... ({current}/{total})",
        "progress_step_2_grouping_legacy": "Step 2/3: Creating duplicate groups...",
        "progress_step_3_rating_start": "Step 3/3: Image rating is starting...",
        "progress_step_3_rating_legacy": "Step 3/3: Rating images",
        "progress_step_4_finalizing_legacy": "Step 3/3: Preparing finalization and display...",
        "progress_step_current": "Step {step}/{total}",
        "progress_eta": "Remaining time: {eta}",
        "progress_eta_calculating": "Calculating remaining time...",
        "analysis_activity_title": "Analysis activity",
        "analysis_activity_ready": "Progress started",
        "cancel_in_progress": "Cancelling in progress...",
        "warning": "Warning",
        "success": "Success",

        "exif_data_header": "<h4>EXIF Data</h4>",
        "exif_loading": "<i>Loading EXIF data...</i>",
        "exif_display_error": "<i>Error displaying EXIF data: {error}</i>",
        "exif_load_error": "<i>EXIF data could not be loaded: {error}</i>",
        "zoom_ctrl_wheel_fine": "Ctrl+Wheel: Fine zoom",
        "zoom_reset": "0: Reset zoom",
        "zoom_fit_view": "Double-click: Fit view",
        "zoom_drag_pan": "Drag: Pan image",
        "detail_dialog_title": "Detail: {name}",
        "detail_window_title": "Detail view - {name}",
        "detail_badge_recommended": "Recommended",
        "detail_badge_locked": "Locked",
        "no_quality_data_available": "No quality data available",
        "image_could_not_be_loaded": "Image could not be loaded",
        "exif_no_data": "<i>No EXIF data available</i>",
        "exif_display_error_simple": "<i>Error displaying EXIF data</i>",
        "exif_load_error_simple": "<i>EXIF data could not be loaded</i>",
        "progress_rating_images": "Rating images...",
        "progress_loading_models": "Loading models...",
        "progress_rating_images_count": "Rating images... {done}/{total}",
        "progress_re_rating_group": "Re-rating group...",

        "error_report_email_placeholder": "example@website.com",
        "error_report_empty_input": "Please provide an email or a message.",

        "analysis_error_title": "Analysis error",
        "analysis_error_header": "An error occurred during analysis:\n\n",
        "analysis_error_details": "Error details: {error}\n\n",
        "analysis_error_checklist": "Please ensure that:\n• The folder contains valid image files\n• You have read permissions for the folder\n• Sufficient disk space is available",

        "mtcnn_warning_title": "Face detection notice",
        "mtcnn_warning_header": "<b>Modern face detection unavailable</b>",
        "mtcnn_warning_body": "PhotoCleaner could not initialize modern face detection (MTCNN).\n\nError: {error}\n\nThe app will continue using an older method (Haar Cascade) for face detection. This may reduce accuracy when selecting the best photos with faces.\n\nSharpness, exposure, and other quality analysis features continue to work normally.",
        ...
        # QUICK-WIN #3: Confirmation dialogs
        "confirm_delete_files": "Really delete {count} image(s)?",
        "affected_files": "Affected files:",
        "warning_cannot_undo": "This action cannot be undone!",
        "confirm_batch_operation": "Confirm batch operation",
        "mark_files_as": "Mark {count} image(s) as '{status}'?",
        
        # QUICK-WIN #1: Empty states
        "gallery_empty_title": "No images in gallery",
        "gallery_empty_subtitle": "Let me help you get started",
        "gallery_empty_steps": "Getting started:",
        "gallery_empty_step1": "Scan a folder for images",
        "gallery_empty_step2": "App analyzes and detects duplicates",
        "gallery_empty_step3": "Review duplicate groups",
        "gallery_empty_step4": "Export the best versions",
        "gallery_empty_import_button": "Scan a folder now",
        
        # QUICK-WIN #5: Hardcoded strings → i18n
        "preset_loaded": "Preset '{name}' loaded",
        "preset_saved": "Preset '{name}' saved",
        "preset_cannot_delete_builtin": "Cannot delete built-in preset '{name}'.",
        "settings_updated": "Settings updated",
        "config_validation_error": "Error in '{key}': {error}",
        "quality_details_missing": "Details missing: please re-run analysis for this file.",
        "preset_label": "Preset:",
        "update_available": "Update available",
        "update_new_version": "New version available: {latest}\nCurrently installed: {current}",
        "update_open_download_prompt": "Open download page now?",
        "update_open_download": "Open download",
        "update_later": "Later",
        "update_link_failed": "Could not open download link:\n{url}",
        "update_manifest_no_version": "Manifest missing latest_version",
        "update_manifest_no_url": "Manifest missing download_url",
        "update_up_to_date": "You are already using the latest version ({version}).",
        "eye_detection_config_apply_failed": "Configuration could not be applied. Please check the settings.",
        "installation_select_package": "Please select a package to install.",
        "information": "Information",
    },
    "fr": {
