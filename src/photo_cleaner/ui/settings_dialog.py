...
class SettingsDialog(QDialog):
    ...
    def _build_ui(self):
        ...
        self.tabs.addTab(self._build_quality_tab(), t("quality_tab"))
        
        # Tab 2: Detection Settings
        self.tabs.addTab(self._build_detection_tab(), t("detection_tab"))
        
        # Tab 3: Output Settings
        self.tabs.addTab(self._build_output_tab(), t("export_tab"))

        # Tab 4: Maintenance
        self.tabs.addTab(self._build_maintenance_tab(), t("maintenance_tab"))
    ...
    def _build_detection_tab(self) -> QWidget:
        ...
        # Eye Detection
        eye_group = QGroupBox(f"{t('eye_detection')}")
        ...
        # Image Issues Detection
        issues_group = QGroupBox(f"{t('error_detection')}")
        issues_layout = QVBoxLayout(issues_group)
        issues_layout.setSpacing(8)
        
        self.blurry_check = QCheckBox(t("blur_detection"))
        issues_layout.addWidget(self.blurry_check)
        
        self.underexposed_check = QCheckBox("Unterbelichtet")
        issues_layout.addWidget(self.underexposed_check)
        
        self.overexposed_check = QCheckBox("Überbelichtet")
        issues_layout.addWidget(self.overexposed_check)
        
        layout.addWidget(issues_group)
        
        # Duplicate Detection
        dup_group = QGroupBox(f"{t('duplicate_groups')}")
        dup_layout = QVBoxLayout(dup_group)
        
        dup_layout.addWidget(self._make_label(t("similarity_threshold")))
        ...
        dup_layout.addWidget(self.similarity_spin)
